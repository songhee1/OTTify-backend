...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    public void checkRefreshTokenAndReIssueAccessToken(HttpServletResponse response, String refreshToken) {
        ...
        .ifPresent( redisToken -> {
            log.info(redisToken.getRefreshToken());
            removeRefreshToken(refreshToken);
            String email = redisToken.getEmail();
            String reIssuedRefreshToken = reIssueRefreshToken(email);
            jwtService.sendAccessAndRefreshToken(response, email, jwtService.createAccessToken(email),
                    reIssuedRefreshToken);
        });

//        String email = tokenService.getValues(refreshToken);
//        if(email != null) {
//            removeRefreshToken(refreshToken);
//            String reIssuedRefreshToken = reIssueRefreshToken(email);
//            jwtService.sendAccessAndRefreshToken(response, email, jwtService.createAccessToken(email), reIssuedRefreshToken);
//        }
    ...
    private String reIssueRefreshToken(String email) {
        ...
        tokenService.saveTokenInfo(reIssuedRefreshToken, email);
