...
//    private RefreshTokenRepository tokenRepository;
     ...
     */
    public void sendAccessAndRefreshToken(HttpServletResponse response, String email, String accessToken, String refreshToken) {
        response.setStatus(HttpServletResponse.SC_OK);
        log.info(refreshToken);
//        tokenRepository.save(new RefreshToken(refreshToken, email));
        updateRefreshToken(email, refreshToken);
        setAccessTokenHeader(response, accessToken);
        setRefreshTokenHeader(response, refreshToken);
        log.info("Access Token, Refresh Token 반환");
    ...
    public void updateRefreshToken(String email, String refreshToken) {
        tokenService.saveTokenInfo(refreshToken, email);
    }
